...
authors:
- Gavin King
customMessage: Expect smoke near to active wildfires across the
  province. As winds change through the expect smoke to be highly
  variable across the landscape.
date: 2025-09-11
ice: Issue
location: Multiple regions in B.C.
params:
  customMessage: "Expect smoke near to active wildfires across the province. As winds change through the expect smoke to be highly variable across the landscape."
  ice: Issue
  location: Multiple regions in B.C.
  nextUpdate: 2025-09-12
  aqMet: Gavin King
  regions:
  - 100 Mile
...
Expect smoke near to active wildfires across the province. As winds
change through the expect smoke to be highly variable across the
landscape.
...
The next update will be available on September 12, 2025 and made
...
Vancouver.](2025-09-11_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for September 11, 2025: 100 Mile, B.C. South Peace River, Cariboo (North), Cariboo (South), Chilcotin, Manning - Skagit Valley, McGregor, Prince George, South Thompson, Yellowhead."

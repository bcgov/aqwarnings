...
authors:
- Gavin King
customMessage: There are new fire starts across the province, expect
  smoke near to active fires.
date: 2025-08-30
ice: Issue
location: Central Interior
params:
  customMessage: "There are new fire starts across the province, expect smoke near to active fires."
  ice: Issue
  location: Central Interior
  nextUpdate: 2025-08-31
  aqMet: Gavin King
  regions:
...
There are new fire starts across the province, expect smoke near to
active fires.
...
The next update will be available on August 31, 2025 and made available
...
Vancouver.](2025-08-30_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 30, 2025: Cariboo (North), Chilcotin, Prince George."

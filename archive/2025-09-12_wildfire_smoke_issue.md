...
authors:
- Gavin King
customMessage: Wildfire smoke will continue to be highly variable across
  the province due to changing wind conditions.
date: 2025-09-12
ice: Issue
location: Multiple regions in B.C.
params:
  customMessage: "Wildfire smoke will continue to be highly variable across the province due to changing wind conditions."
  ice: Issue
  location: Multiple regions in B.C.
  nextUpdate: 2025-09-13
  aqMet: Gavin King
  regions:
  - 100 Mile
...
Wildfire smoke will continue to be highly variable across the province
...
The next update will be available on September 13, 2025 and made
...
Vancouver.](2025-09-12_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for September 12, 2025: 100 Mile, B.C. South Peace River, Boundary, Cariboo (North), Cariboo (South), McGregor, North Thompson, Prince George, West Kootenay, Yellowhead."

...
params:
  customMessage: "Smoke haze will be present across the majority of the B.C. landscape and can be highly variable. Smoke is expected to clear in the Peace region over the coming days. Smoke is predicted to move into the Thompson, Shuswap and Okanagan regions during the overnight period."
  ice: Issue
  location: Multiple regions in B.C.
  nextUpdate: 2025-09-04
  aqMet: Gavin King
  regions:
  - 100 Mile

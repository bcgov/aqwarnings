...
authors:
- Gavin King
customMessage: Expect local smoke close new and active fires across the
  province. Degraded conditions will persist in areas with local
  emissions.
date: 2025-08-31
ice: Issue
...
Expect local smoke close new and active fires across the province.
Degraded conditions will persist in areas with local emissions.
...
The next update will be available on September 01, 2025 and made
...
Vancouver.](2025-08-31_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 31, 2025: B.C. North Peace River, B.C. South Peace River, Chilcotin, Fort Nelson."

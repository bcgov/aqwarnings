...
authors:
- Gavin King
customMessage: Expect increasing smoke in the Lakes District and Cariboo
  regions. Smoke will be highly variable across all regions and areas
...
Expect increasing smoke in the Lakes District and Cariboo regions. Smoke
will be highly variable across all regions and areas outside of Air
Quality Warning regions may have smoke haze.
...
The next update will be available on September 03, 2025 and made
...
Vancouver.](2025-09-02_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for September 02, 2025: 100 Mile, B.C. North Peace River, B.C. South Peace River, Cariboo (North), Cariboo (South), Central Coast (inland sections), Chilcotin, Fort Nelson, Lakes District, McGregor, Prince George, Stuart - Nechako, Williston."

...
authors:
- Donna Haga
customMessage: Despite significant precipitation in the Northeast,
  continued smoke impacts are predicted today. In the Fraser Canyon,
  smoke from the Izman Creek wildfire is impacting Lytton and
  surrounding areas.
date: 2025-07-03
ice: Issue
location: Northeast BC and the Fraser Canyon (Lytton area)
params:
  customMessage: "Despite significant precipitation in the Northeast, continued smoke impacts are predicted today. In the Fraser Canyon, smoke from the Izman Creek wildfire is impacting Lytton and surrounding areas."
  ice: Issue
  location: Northeast B.C. and the Fraser Canyon (Lytton area)
  nextUpdate: 2025-07-04
  aqMet: Donna Haga
  regions:
  - Fort Nelson
...
Despite significant precipitation in the Northeast, continued smoke
impacts are predicted today. In the Fraser Canyon, smoke from the Izman
Creek wildfire is impacting Lytton and surrounding areas.
...
The next update will be available on July 04, 2025 and made available on
...
Vancouver.](2025-07-03_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 03, 2025: Fort Nelson, Fraser Canyon (South)."

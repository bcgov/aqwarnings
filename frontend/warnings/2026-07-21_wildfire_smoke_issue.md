...
parametersAsRendered:
  aqMet: Gavin King
  customMessage: Smoke across the Skeena region is expected to thin
    during the day but persist in valley bottoms overnight. In southern
    areas, smoke is forecasted to increase as winds from the south
    transport smoke across the border. These winds are forecasted to
    shift smoke eastward through the day.
  location: Multiple regions in B.C.
  nextUpdate: 2026-07-22
...
Smoke across the Skeena region is expected to thin during the day but
persist in valley bottoms overnight. In southern areas, smoke is
forecasted to increase as winds from the south transport smoke across
the border. These winds are forecasted to shift smoke eastward through
the day.
...
The next update will be available on July 22, 2026 and made available on
...
Vancouver.](2026-07-21_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 21, 2026: 100 Mile, B.C. North Peace River, B.C. South Peace River, Boundary, Bulkley Valley, Cariboo (North), Cariboo (South), Chilcotin, East Kootenay (South), Fort Nelson, Fraser Canyon (North), Fraser Canyon (South), Kootenay Lake, Lakes District, Manning - Skagit Valley, McGregor, Prince George, Similkameen, South Okanagan , South Thompson, Stuart - Nechako, West Kootenay, Williston."
...
-   **Bulkley Valley:** includes Hazelton, Smithers, Telkwa, and
    Granisle.
...
-   **Lakes District:** includes Houston, Topley, Burns Lake, and
    Endako.
-   **Manning - Skagit Valley:** includes Sunshine Valley, Manning Park,
    and Eastgate.
-   **McGregor:** includes the northern end of the Robson Valley
    extending from Hansard to Dome Creek; extends north to Monkman Park.

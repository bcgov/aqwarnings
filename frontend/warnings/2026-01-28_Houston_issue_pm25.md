...
burnRestrictions: 0
bylaw: true
custom_message: Current conditions are expected to persist until weather
...
The next update will be on January 29, 2026 and posted to the province's
...
communities at 5:00 PM local time today:
  ...
  Community              Houston   Burns Lake Prince       Smithers   Vanderhoof
                                              George                  
  ---------------------- --------- ---------- ------------ ---------- ------------
  24-hr average          7.8       5.3        10.7         7.4        12.5
  (μg/m^3^)                                                           

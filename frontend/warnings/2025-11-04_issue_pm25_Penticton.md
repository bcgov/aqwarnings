...
Warning](/warnings/2025-11-04_issue_pm25_Penticton.pdf) for the
...
PM$_{2.5}$ concentrations are summarized below for Penticton and nearest
monitored communities at local time today:

  Community                        Grand Forks   Kelowna   Vernon
  -------------------------------- ------------- --------- --------
  24-hr average ($\mu$g/m$^{3}$)   9.2           10.6      13.5

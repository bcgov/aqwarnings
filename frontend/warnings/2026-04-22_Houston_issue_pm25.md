...
parametersAsRendered:
  aqMet: Gail Roth
  burnRestrictionArea: 50km of the Cranbrook Regional Hospital
...
very high levels of fine particulate matter.
...
Avoid strenuous outdoor activities until the warning has ended. Stay
indoors in a space with filtered air. Monitor your symptoms and seek
...
Exposure to high levels of air contaminants pose a threat to your health
regardless of age or health status. Avoid outdoor activities. Stay
indoors in a space with filtered air.
...
-   Houston bylaw 947 restricts the use of wood burning appliances and
    ...
    -   **3.2**: No person shall conduct open burning or ignite or
        maintain any recreational fire if an air quality advisory has
        been issued.
    ...
    -   **3.3**: If an air quality advisory is issued while a person is
        ...
        person shall take all reasonable steps to cease the open burning
        or extinguish the recreational fire as soon as possible.

    -   Contact the Houston municipal office at
        [250-845-2238](tel:2508452238) for more information on woodstove
        and open burning restrictions.
...
communities at 7:00 PM local time today:

::: {.table-responsive}

  --------------------------------------------------------------------------------
  Community              Houston   Burns Lake Prince       Smithers   Vanderhoof
                                              George                  
  ---------------------- --------- ---------- ------------ ---------- ------------
  24-hr average          4.0       3.2        1.8          2.8        5.2
  (μg/m^3^)                                                           

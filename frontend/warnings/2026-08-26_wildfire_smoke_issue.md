...
parametersAsRendered:
  aqMet: Gail Roth
  customMessage: Hazy conditions are expected across much of southern
    and central B.C. Smoke impacts in northeastern regions are not
    expected until tomorrow morning, with conditions remaining generally
    favourable through today.
  location: Multiple regions in B.C.
  nextUpdate: 2026-08-27
...
Hazy conditions are expected across much of southern and central B.C.
Smoke impacts in northeastern regions are not expected until tomorrow
morning, with conditions remaining generally favourable through today.
...
The next update will be available on August 27, 2026 and made available
...
Vancouver.](2026-08-26_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 26, 2026: 100 Mile, B.C. South Peace River, Central Okanagan, Fort Nelson, Fraser Canyon (South), Manning - Skagit Valley, McGregor, Nicola, Similkameen, South Okanagan , South Thompson."

...
parametersAsRendered:
  ...
  warningLevel:
    ...
    orange: Fraser Canyon - south including Lytton
    yellow:
    - Fraser Canyon - north including Lillooet
    - South Thompson
    - Nicola
...
The next update will be available on July 10, 2026 and made available on
...
Vancouver.](2026-07-09_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 09, 2026: East Columbia, East Kootenay (North), Fraser Canyon (North), Fraser Canyon (South), Nicola, Shuswap, South Thompson, West Columbia, Yoho - Kootenay Park."

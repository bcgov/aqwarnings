...
parametersAsRendered:
  aqMet: Gavin King
  customMessage: Smoke is predicted to move into the Kootenay region
    from the south during the day. Smoke is predicted to continue to
    move south and west from the Peace region through the day. Smoke
    will continue to impact the Fraser Canyon and western side of the
    South Thompson.
  location: Multiple regions in B.C.
  nextUpdate: 2026-07-21
...
Smoke is predicted to move into the Kootenay region from the south
during the day. Smoke is predicted to continue to move south and west
from the Peace region through the day. Smoke will continue to impact the
Fraser Canyon and western side of the South Thompson.
...
The next update will be available on July 21, 2026 and made available on
...
Vancouver.](2026-07-20_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 20, 2026: B.C. North Peace River, B.C. South Peace River, East Kootenay (South), Fort Nelson, Fraser Canyon (North), Fraser Canyon (South), Kootenay Lake, McGregor, Prince George, South Thompson, West Kootenay, Williston."

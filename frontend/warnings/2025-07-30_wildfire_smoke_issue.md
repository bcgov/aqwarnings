...
authors:
- Vickie Irish
customMessage: Smoke in South Thompson region only expected to affect
...
Smoke in South Thompson region only expected to affect Cache Creek and
Ashcroft.
...
The next update will be available on July 31, 2025 and made available on
...
Vancouver.](2025-07-30_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 30, 2025: Fraser Canyon (North), Fraser Canyon (South), South Thompson."
...
-   Fraser Canyon (North): includes Lillooet and Anderson Lake.

...
ice: Issue
level: yellow / orange
location: Southern and Central Interior
parametersAsRendered:
  aqMet: Donna Haga
  customMessage: Smoke continues to pool under the high pressure system
    parked over BC, with widespread air quality impacts throughout the
    Southern and Central Interior. Brief and sporadic pockets of
    clearing may occur in some regions today, but widespread clearing is
    not expected.
  location: Southern and Central Interior
  nextUpdate: 2026-08-08
...
Smoke continues to pool under the high pressure system parked over BC,
with widespread air quality impacts throughout the Southern and Central
Interior. Brief and sporadic pockets of clearing may occur in some
regions today, but widespread clearing is not expected.
...
The next update will be available on August 08, 2026 and made available
...
Vancouver.](2026-08-07_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 07, 2026: 100 Mile, Arrow Lakes - Slocan Lake, Boundary, Central Okanagan, Chilcotin, East Columbia, East Kootenay (North), East Kootenay (South), Elk Valley, Fraser Canyon (North), Fraser Canyon (South), Kinbasket, Kootenay Lake, Manning - Skagit Valley, Nicola, North Columbia, North Harrison Lake, North Okanagan, North Thompson, Shuswap, Similkameen, South Okanagan , South Thompson, West Columbia, West Kootenay, Whistler, Yoho - Kootenay Park."

...
title: Pollution Prevention Notice and open burning restrictions are in
  effect within THIS IS A TEST - not an actual warning.
...
A TEST - not an actual warning. due to elevated fine particulate matter.
...
The next update will be on January 08, 2026 and posted to the province's
...
> TEST - not an actual warning. until January 08, 2026 12:00 PM local
...
   Date issued: January 07, 2026`<br />`{=html}   Benjamin
...
communities at 4:00 PM local time today:
  ...
  --------------------------- -------- ----------- ----------- --------- ----------
  24-hr average (μg/m^3^)     2.6      4.7         1.0         0.4       0.7

  Max. within 24 hr (μg/m^3^) 8.4      10.2        2.1         1.7       3.3
  ---------------------------------------------------------------------------------

...
parametersAsRendered:
  ...
  burnRestrictionEndDate: 20583
  burnRestrictionEndTime: "HH:00 PM"
  burnRestrictionSDM: 1
...
May 08, 2026 for Quesnel due to elevated levels of coarse particulate
matter.
...
::: {.table-responsive}
  ...
  ------------------------- --------- --------------- ---------------
  24-hr average (μg/m^3^)   39.3      22.4            18.3

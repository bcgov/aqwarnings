...
parametersAsRendered:
  aqMet: Gavin King
  customMessage: Wildfire smoke may clear through the afternoon as winds
    change. However there is potential to see build up of smoke into the
    overnight period.
  location: Central Interior
  ...
  twoLevels: false
  warningLevel:
    all: Fraser Canyon - south including Lytton
    yellow: Fraser Canyon - south including Lytton
params:
  aqMet: Sakshi Jain
...
Wildfire smoke may clear through the afternoon as winds change. However
there is potential to see build up of smoke into the overnight period.
...
The next update will be available on June 21, 2026 and made available on
...
Vancouver.](2026-06-20_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for June 20, 2026: Fraser Canyon (South)."

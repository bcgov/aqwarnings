...
parametersAsRendered:
  aqMet: Gavin King
  customMessage: Winds will change through the day with smoke predicted
    to build in the 100 mile zone through the day. Smoke is predicted to
    gradually thin in the south east but remain in valleys. Smoke will
    be present near active fires.
  location: Multiple regions in B.C.
  nextUpdate: 2026-07-19
...
Winds will change through the day with smoke predicted to build in the
100 mile zone through the day. Smoke is predicted to gradually thin in
the south east but remain in valleys. Smoke will be present near active
fires.
...
The next update will be available on July 19, 2026 and made available on
...
Vancouver.](2026-07-18_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 18, 2026: 100 Mile, Boundary, East Kootenay (South), Kootenay Lake, West Kootenay."

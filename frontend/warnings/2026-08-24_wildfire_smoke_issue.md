...
parametersAsRendered:
  aqMet: Gail Roth
  customMessage: For the South Thompson region, the highest smoke
    concentrations are expected southwest of Kamloops, including Spences
    Bridge.
  location: Multiple regions in B.C.
...
For the South Thompson region, the highest smoke concentrations are
expected southwest of Kamloops, including Spences Bridge.
...
The next update will be available on August 25, 2026 and made available

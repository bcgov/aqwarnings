...
parametersAsRendered:
  ...
  customMessage: Wildfire smoke concentrations have reduced over the
    past 24 hours. However, smoke will persist locally near active
    fires.
  healthAuth:
...
However, smoke will persist locally near active fires.

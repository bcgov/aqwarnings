...
parametersAsRendered:
  ...
  warningLevel:
    ...
    orange: Cariboo - north including Quesnel
    yellow: Cariboo - south including Williams Lake
params:
  aqMet: Sakshi Jain
...
The next update will be available on May 01, 2026 and made available on
...
Vancouver.](2026-04-30_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for April 30, 2026: Cariboo (North), Cariboo (South)."

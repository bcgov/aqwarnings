...
February 17, 2026 for Quesnel due to elevated levels of fine particulate
matter and coarse particulate matter.
...
::: {.table-responsive}
  ...
  ------------------------- --------- --------------- ---------------
  24-hr average (μg/m^3^)   2.6       2.1             2.0
...
::: {.table-responsive}
  ...
  Community                 Quesnel   Prince George   Williams Lake
  ------------------------- --------- --------------- ---------------
  24-hr average (μg/m^3^)   14.0      14.9            11.0

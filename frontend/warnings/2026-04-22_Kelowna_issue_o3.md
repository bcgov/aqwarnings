...
params:
  ...
  warningLevel: yellow
pollutant: O3
title: Air quality warning in effect for Kelowna
...
very high levels of ground level ozone.
...
-   When indoors, keep windows and doors closed. -Air cleaners can help
    improve indoor air quality, but avoid models that generate ozone, as
    these can produce harmful ozone concentrations indoors.
...
::: {.table-responsive}
  ...
  ------------------------ --------- ---------- --------
  8-hr average (ppb)       37.8      46.4       43.3
  Max. within 8 hr (ppb)   44.5      48.9       51.8

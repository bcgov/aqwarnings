...
parametersAsRendered:
  ...
  customMessage: Smoke impacts continue across the southern Interior and
    southeast B.C., including smoke from wildfires south of the
    Canada--U.S. border. Smoke also persists in northeast B.C.,
    particularly around Fort St. John. Conditions are expected to be
    highly variable through the day as winds change, with smoke likely
    near active fires.
  location: Multiple regions in B.C.
  nextUpdate: 2026-08-29
...
Smoke impacts continue across the southern Interior and southeast B.C.,
including smoke from wildfires south of the Canada--U.S. border. Smoke
also persists in northeast B.C., particularly around Fort St. John.
Conditions are expected to be highly variable through the day as winds
change, with smoke likely near active fires.
...
The next update will be available on August 29, 2026 and made available
...
Vancouver.](2026-08-28_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 28, 2026: Arrow Lakes - Slocan Lake, B.C. North Peace River, B.C. South Peace River, Boundary, Central Okanagan, East Kootenay (North), East Kootenay (South), Elk Valley, Fort Nelson, Kootenay Lake, South Okanagan , West Kootenay, Yoho - Kootenay Park."

...
The next update will be on January 30, 2026 and posted to the province's
...
communities at 8:00 PM local time today:
  ...
  ------------------------- ----------- ----------- --------- -------- ----------
  24-hr average (μg/m^3^)   5.4         14.2        2.8       14.5     1.1

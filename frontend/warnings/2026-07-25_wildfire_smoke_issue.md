...
parametersAsRendered:
  aqMet: Gail Roth
  customMessage: In the northern Cariboo region, smoke impacts are
    expected to be most pronounced in eastern areas, particularly along
    Highway 26. In the Southern Okanagan region, smoke impacts are
    expected to be most prevalent in southern communities, including
    Osoyoos and Oliver.
  location: Multiple regions in B.C.
...
In the northern Cariboo region, smoke impacts are expected to be most
pronounced in eastern areas, particularly along Highway 26. In the
Southern Okanagan region, smoke impacts are expected to be most
prevalent in southern communities, including Osoyoos and Oliver.
...
The next update will be available on July 26, 2026 and made available on
...
Vancouver.](2026-07-25_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 25, 2026: 100 Mile, Arrow Lakes - Slocan Lake, Boundary, Cariboo (North), Cariboo (South), Chilcotin, Fraser Canyon (South), Kootenay Lake, Nicola, North Thompson, Shuswap, Similkameen, South Okanagan , South Thompson, West Columbia, West Kootenay, Yellowhead."

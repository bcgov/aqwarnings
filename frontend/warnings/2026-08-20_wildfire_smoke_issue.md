...
ice: Issue
level: yellow / orange
location: Southern Interior and Southeast B.C.
parametersAsRendered:
  aqMet: Gail Roth
  customMessage: In the South Thompson region, the heaviest smoke
    impacts are expected near Cache Creek tonight through tomorrow
    morning. While the region includes Kamloops, smoke impacts there are
    expected to be less pronounced.
  location: Southern Interior and Southeast B.C.
  nextUpdate: 2026-08-21
...
In the South Thompson region, the heaviest smoke impacts are expected
near Cache Creek tonight through tomorrow morning. While the region
includes Kamloops, smoke impacts there are expected to be less
pronounced.
...
The next update will be available on August 21, 2026 and made available
...
Vancouver.](2026-08-20_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 20, 2026: Arrow Lakes - Slocan Lake, Boundary, Central Okanagan, East Columbia, East Kootenay (North), East Kootenay (South), Elk Valley, Fraser Canyon (North), Fraser Canyon (South), Kootenay Lake, Manning - Skagit Valley, Nicola, North Okanagan, Similkameen, South Okanagan , South Thompson, West Columbia, West Kootenay, Yoho - Kootenay Park."

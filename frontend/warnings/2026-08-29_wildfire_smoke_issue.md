...
parametersAsRendered:
  ...
  customMessage: Smoke has cleared from northeast B.C. but remains
    across parts of southeast B.C. Smoke is expected to continue
    dissipating throughout the day as it moves eastward, with localized
    impacts still possible.
  location: Multiple regions in B.C.
  nextUpdate: 2026-08-30
...
Smoke has cleared from northeast B.C. but remains across parts of
southeast B.C. Smoke is expected to continue dissipating throughout the
day as it moves eastward, with localized impacts still possible.
...
The next update will be available on August 30, 2026 and made available
...
Vancouver.](2026-08-29_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 29, 2026: Arrow Lakes - Slocan Lake, Boundary, East Columbia, East Kootenay (North), East Kootenay (South), Elk Valley, Kootenay Lake, West Kootenay, Yoho - Kootenay Park."

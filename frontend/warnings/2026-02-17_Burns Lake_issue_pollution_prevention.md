...
Health Authority has issued a Pollution Prevention Notice within
`<location>`{=html} due to elevated fine particulate matter.

Open burning restrictions are now in effect within `<location>`{=html}.
No new fires may be initiated, and no additional material may be added
to existing fires. For more information on burning restrictions, refer
to the Mandatory Emission Reduction Actions section below.
...
The next update will be on February 18, 2026 and posted to the
...
> Regulation, the Director has prohibited open burning within
> `<location>`{=html} until February 18, 2026 HH:00 AM local time. No
...
   Date issued: February 17, 2026`<br />`{=html}   Benjamin
...
communities at 11:00 PM local time today:
...
::: {.table-responsive}
  ...
  Community              Burns Lake Houston   Prince       Smithers   Vanderhoof
                                              George                  
  ---------------------- ---------- --------- ------------ ---------- ------------
  24-hr average          8.6        1.8       2.0          3.1        9.1
  (μg/m^3^)                                                           

...
ice: Issue
level: yellow
location: Several regions in southern B.C. and Fort Nelson
parametersAsRendered:
  aqMet: Gail Roth
  customMessage: Smoke concentrations are expected to generally improve
    across affected areas through the day today, with smoke returning in
    southern regions during the overnight period.
  location: Several regions in southern B.C. and Fort Nelson
  nextUpdate: 2026-08-26
...
Smoke concentrations are expected to generally improve across affected
areas through the day today, with smoke returning in southern regions
...
The next update will be available on August 26, 2026 and made available
...
Vancouver.](2026-08-25_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 25, 2026: Fort Nelson, Fraser Canyon (South), Manning - Skagit Valley, Nicola, Similkameen, South Okanagan ."

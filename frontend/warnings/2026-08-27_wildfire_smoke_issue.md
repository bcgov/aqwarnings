...
parametersAsRendered:
  ...
  customMessage: |
    Smoke remains evident across the southern Interior and southeast,
    with some additional smoke moving northward from wildfires south of
    the Canada--U.S. border. In northeastern BC, smoke from fires
    farther north continues to move toward the Fort Nelson area.

    During a wildfire, smoke conditions can change quickly over short
    distances and vary considerably hour by hour.
  location: Multiple regions in B.C.
  nextUpdate: 2026-08-28
...
Smoke remains evident across the southern Interior and southeast, with
some additional smoke moving northward from wildfires south of the
Canada--U.S. border. In northeastern BC, smoke from fires farther north
continues to move toward the Fort Nelson area.
...
The next update will be available on August 28, 2026 and made available
...
Vancouver.](2026-08-27_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 27, 2026: B.C. South Peace River, Boundary, Central Okanagan, Fort Nelson, Kootenay Lake, McGregor, Muncho Lake Park - Stone Mountain Park, Nicola, North Okanagan, North Thompson, Shuswap, Similkameen, South Okanagan , South Thompson, West Kootenay."
...
-   **Muncho Lake Park - Stone Mountain Park:** includes Muncho Lake,
    Toad River and Stone Mountain Provincial Park.

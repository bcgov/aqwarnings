...
parametersAsRendered:
  aqMet: Gavin King
  customMessage: Smoke across northern British Columbia is predicted to
    shift eastward during the day. Along the southern border, smoke is
    forecast to spread north and east into the Kootenays, with visible
    smoke affecting the Elk Valley region.
  location: Multiple regions in B.C.
  nextUpdate: 2026-07-23
...
Smoke across northern British Columbia is predicted to shift eastward
during the day. Along the southern border, smoke is forecast to spread
north and east into the Kootenays, with visible smoke affecting the Elk
Valley region.
...
The next update will be available on July 23, 2026 and made available on
...
Vancouver.](2026-07-22_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 22, 2026: 100 Mile, Arrow Lakes - Slocan Lake, B.C. North Peace River, B.C. South Peace River, Boundary, Cariboo (North), Cariboo (South), Central Okanagan, East Columbia, East Kootenay (South), Fort Nelson, Fraser Canyon (North), Fraser Canyon (South), Kootenay Lake, Manning - Skagit Valley, McGregor, Nicola, North Okanagan, North Thompson, Prince George, Shuswap, Similkameen, South Okanagan , South Thompson, Stuart - Nechako, West Columbia, West Kootenay, Williston."

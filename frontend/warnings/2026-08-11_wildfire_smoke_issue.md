...
parametersAsRendered:
  aqMet: Donna Haga
  customMessage: Some improvement has occurred in some regions, but the
    Central and Southern Interior remain widely impacted by wildfire
    smoke.
  location: Central and Southern Interior
  nextUpdate: 2026-08-12
...
Some improvement has occurred in some regions, but the Central and
Southern Interior remain widely impacted by wildfire smoke.
...
The next update will be available on August 12, 2026 and made available
...
Vancouver.](2026-08-11_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for August 11, 2026: 100 Mile, Arrow Lakes - Slocan Lake, Boundary, Central Okanagan, East Columbia, East Kootenay (North), East Kootenay (South), Elk Valley, Fraser Canyon (North), Fraser Canyon (South), Kootenay Lake, Manning - Skagit Valley, Nicola, North Okanagan, Shuswap, Similkameen, South Okanagan , South Thompson, West Columbia, West Kootenay."

...
parametersAsRendered:
  aqMet: Gavin King
  customMessage: Smoke will move south through the Peace region during
    the day. Changing winds in the south will bring variable smoke that
    will change though the day and by local area as wind direction
    changes.
  location: Multiple regions in B.C.
...
Smoke will move south through the Peace region during the day. Changing
winds in the south will bring variable smoke that will change though the
day and by local area as wind direction changes.
...
The next update will be available on July 20, 2026 and made available on
...
Vancouver.](2026-07-19_wildfire_smoke_issue_map.html){fig-alt="Air Quality Warning - Wildfire Smoke Regions for July 19, 2026: B.C. North Peace River, B.C. South Peace River, East Kootenay (South), Fort Nelson, Fraser Canyon (North), Fraser Canyon (South), Kootenay Lake, South Thompson."
